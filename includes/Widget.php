...
class Widget extends \WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = array(
			'description' => esc_html__( 'Future Events.', $this->plugin_slug ),
		);

		parent::__construct( 'wpr-future-events', esc_html__( 'WPR Future Events', $this->plugin_slug ), $widget_ops );
	}
	...
	public function widget( $args, $instance ) {
		...
		$object_name = 'wpr_future_object_' . uniqid();

		$data = get_option('wpr_future_events');
		$object = array(
		...
		?><div class="wpr-future-event-widget" data-object-id="<?php echo $object_name ?>"></div><?php
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>">
				<?php esc_html_e( 'Title:', 'wpr-future-events' ); ?>
			</label>
